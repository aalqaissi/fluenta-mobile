# Graph Report - D:\personal\fluenta-mobile  (2026-09-16)

## Corpus Check
- 35 files · ~53,614 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1273 nodes · 1944 edges · 77 communities (74 shown, 3 thin omitted)
...
Cohesion: 0.07
Nodes (30): DateTime get, _band, build, _category, confirmLabel, context, createState, _date (+22 more)
...
Cohesion: 0.08
Nodes (25): AppConfig, Client, Exception, ApiException, config, createCertificate, createFeedback, getAchievements (+17 more)

### Community 14 - "app_config.dart"
Cohesion: 0.08
Nodes (25): ../full_exam/full_exam_store.dart, _answered, _answers, _bottomBar, createState, dispose, exam, examId (+17 more)
...
Cohesion: 0.13
Nodes (17): AuthState, int get, build, _controller, createState, dispose, initState, _submit (+9 more)
...
Cohesion: 0.25
Nodes (14): Yalla Mobile P0 Foundation Plan, ApiClient + ApiException, AppConfig (persisted Server URL + token), AppState Delegates to AuthState, AuthState + BootStatus, http.testing.MockClient Test Pattern, TDD Task-by-Task Workflow (subagent-driven-development), Build Phasing P0–P6 (§7) (+6 more)
...
Cohesion: 0.19
Nodes (10): build, build, HelpScreen, build, createState, _filter, _kindIcon, package:flutter/material.dart (+2 more)
...
Cohesion: 0.17
Nodes (12): Analysis Options Config, flutter_lints Recommended Lint Set, Launch Screen Assets (iOS), fluenta_mobile pubspec.yaml, cupertino_icons, flutter_lints, Flutter SDK, google_fonts (+4 more)

### Community 34 - "../../widgets/ui.dart"
Cohesion: 0.20
Nodes (11): ChangeNotifier, build, build, _Item, lockKey, PracticeHubScreen, route, soon (+3 more)
...
Cohesion: 0.23
Nodes (12): LessonsScreen, _LessonsScreenState, ListeningRunnerScreen, _ListeningRunnerScreenState, ReadingRunnerScreen, _ReadingRunnerScreenState, WritingHubScreen, _WritingHubScreenState (+4 more)
...
Cohesion: 0.25
Nodes (6): build, package:fluenta_mobile/features/dashboard/dashboard_screen.dart, package:fluenta_mobile/theme/app_theme.dart, package:provider/provider.dart, ../state/auth_state.dart, main
...
- **Why does `fluenta_mobile pubspec.yaml` connect `coach_screen.dart` to `README.md (Mobile)`, `../theme/app_colors.dart`?**
  _High betweenness centrality (0.116) - this node is a cross-community bridge._
- **Why does `Yalla Mobile P0 Foundation Plan` connect `../theme/app_colors.dart` to `Bootstrap Gate: Splash/Offline + Router `, `exam_convert.dart`, `manifest.json`, `auth_state.dart`, `Writing Runner Wired to Backend`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `go_router` connect `README.md (Mobile)` to `coach_screen.dart`?**
